...
import { ChevronUp, ChevronDown } from 'lucide-react'
 ...
 const Faqs = () => {
  return (
    <section className="mx-auto max-w-xxl px-2 py-10 md:px-0"style={{ backgroundColor: "#D9FFEE"}}>
      <div>
        ...
        <div className="mx-auto mt-8 max-w-3xl space-y-4 md:mt-16" >
          <div className="cursor-pointer rounded-md border border-gray-400 shadow-lg transition-all duration-200" style={{ backgroundColor: "#AAD9BB"}}>
            <button
              type="button"
          ...
          {Array.from({ length: 2 }).map((_, i) => (
            <div style={{ backgroundColor: "#b8e0d4"}}
              key={i}
