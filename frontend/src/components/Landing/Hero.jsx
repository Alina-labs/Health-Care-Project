...
const Hero=()=> {
  return (
    <div className="relative w-full" style={{ backgroundColor: "#c5dfd0" }}>
      <div className="mx-auto max-w-7xl lg:px-8">
        <div className="flex flex-col justify-center px-4 py-10 lg:px-8">
          ...
          <h1 className="mt-8 max-w-3xl text-lg text-gray-700">
            The next generation of care for Children and Families
            </h1>
          <div className="mt-8">
            <button
